...
var incrementCart = document.querySelectorAll('.increment');
var decrementCart = document.querySelectorAll('.decrement');
...
function increaseCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/increase-cart', pizza).then(function (res) {
    // console.log(res)
    cartCounter.innerText = res.data.totalQty;
...
function decreaseCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/decrease-cart', pizza).then(function (res) {
    cartCounter.innerText = res.data.totalQty;
    window.location.reload();
    new noty__WEBPACK_IMPORTED_MODULE_1___default.a({
      type: 'success',
...
incrementCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
...
decrementCart.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var pizza = JSON.parse(btn.dataset.pizza);
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return Object(_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__["loadStripe"])('pk_test_51JAahZSG7SdIzAq0dGNMWduYF0WCVkvztyke8OHc4Xb8ArmRFvMfI9C7UPVTZNIcycAb7goCzGxCTg0SEoamHL5i00hoFj18zd');
...
__webpack_require__(/*! D:\final-year-project\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\final-year-project\resources\scss\app.scss */"./resources/scss/app.scss");
